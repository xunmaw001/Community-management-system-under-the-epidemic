		    ...
		    label="体温">
		     <template slot-scope="scope">
                       {{scope.row.tiwen}}
                	                	                                    ...
                	                	                                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    prop="shentishifoubushi"
                    header-align="center"
		    label="身体是否不适">
		     <template slot-scope="scope">
                       {{scope.row.shentishifoubushi}}
                     </template>
                </el-table-column>
                	                	                                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    prop="tiwenshifouzhengchang"
                    header-align="center"
		    label="体温是否正常">
		     <template slot-scope="scope">
                       {{scope.row.tiwenshifouzhengchang}}
                     </template>
                </el-table-column>
                	                	                                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    prop="jiarenzhongshifouyourenquezhenxinguanfeiyan"
                    header-align="center"
		    label="家人中是否有人确诊新冠肺炎">
		     <template slot-scope="scope">
                       {{scope.row.jiarenzhongshifouyourenquezhenxinguanfeiyan}}
                     </template>
                </el-table-column>
                	                	                                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    prop="beizhu"
