          ...
          <el-form-item class="input" label="家庭住址" prop="jiatingzhuzhi">
              <el-input v-model="ruleForm.jiatingzhuzhi" 
                placeholder="家庭住址" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家里成员人数" prop="jialichengyuanrenshu">
          <el-input v-model="ruleForm.jialichengyuanrenshu" 
              placeholder="家里成员人数" clearable  :readonly="ro.jialichengyuanrenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家里成员人数" prop="jialichengyuanrenshu">
              <el-input v-model="ruleForm.jialichengyuanrenshu" 
                placeholder="家里成员人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.tijiaoshijian" label="提交时间" prop="tijiaoshijian">
              <el-input v-model="ruleForm.tijiaoshijian" 
                placeholder="提交时间" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="需求详细" prop="xuqiuxiangxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="需求详细"
                  v-model="ruleForm.xuqiuxiangxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xuqiuxiangxi" label="需求详细" prop="xuqiuxiangxi">
                    <span>{{ruleForm.xuqiuxiangxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiatingzhuzhi = true;
            continue;
	            	            ...
	            	            if(o=='jialichengyuanrenshu'){
            this.ruleForm.jialichengyuanrenshu = obj[o];
	    this.ro.jialichengyuanrenshu = true;
            continue;
          }
	            	            if(o=='xuqiuxiangxi'){
            this.ruleForm.xuqiuxiangxi = obj[o];
	    this.ro.xuqiuxiangxi = true;
            continue;
          }
	            	            if(o=='tijiaoshijian'){
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.yonghuxingming = json.yonghuxingming
                                  		...
                                  		if(json.jiatingzhuzhi!=''&&json.jiatingzhuzhi){
              		this.ruleForm.jiatingzhuzhi = json.jiatingzhuzhi
		}
                                                                                                                                            } else {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `richangxuqiu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.richangxuqiuCrossAddOrUpdateFlag = false;
                  this.parent.search();
