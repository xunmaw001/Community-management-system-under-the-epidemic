          ...
          <el-form-item class="input" v-if="ruleForm.tijiaoshijian" label="提交时间" prop="tijiaoshijian">
              <el-input v-model="ruleForm.tijiaoshijian" 
                placeholder="提交时间" readonly></el-input>
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="建议反馈" prop="jianyifankui">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="建议反馈"
                  v-model="ruleForm.jianyifankui" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianyifankui" label="建议反馈" prop="jianyifankui">
                    <span>{{ruleForm.jianyifankui}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yonghuxingming = true;
            continue;
	            	            ...
	            	            if(o=='jianyifankui'){
            this.ruleForm.jianyifankui = obj[o];
	    this.ro.jianyifankui = true;
            continue;
          }
	            	            if(o=='tijiaoshijian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yijianlan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yijianlanCrossAddOrUpdateFlag = false;
                  this.parent.search();
