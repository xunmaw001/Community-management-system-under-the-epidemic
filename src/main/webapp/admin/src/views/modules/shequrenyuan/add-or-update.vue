<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="社区账号" prop="shequzhanghao">
          <el-input v-model="ruleForm.shequzhanghao" 
              placeholder="社区账号" clearable  :readonly="ro.shequzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="社区账号" prop="shequzhanghao">
              <el-input v-model="ruleForm.shequzhanghao" 
                placeholder="社区账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
                	        ...
                	        shequzhanghao: '',
	                        	        ...
	                        	        jiatingdizhi: '',
                                                                  ...
                                                                  xingbieOptions: [],
                                                                                          rules: {
                  shequzhanghao: [
                            { required: true, message: '社区账号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  xingming: [
                                    	                                                              ],
                  mima: [
