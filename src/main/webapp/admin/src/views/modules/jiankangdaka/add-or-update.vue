  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="体温" prop="tiwen">
              <el-input v-model="ruleForm.tiwen" 
                placeholder="体温" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="身体是否不适" prop="shentishifoubushi">
          <el-select v-model="ruleForm.shentishifoubushi" placeholder="请选择身体是否不适">
            <el-option
                v-for="(item,index) in shentishifoubushiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="身体是否不适" prop="shentishifoubushi">
	      <el-input v-model="ruleForm.shentishifoubushi"
                placeholder="身体是否不适" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="体温是否正常" prop="tiwenshifouzhengchang">
          <el-select v-model="ruleForm.tiwenshifouzhengchang" placeholder="请选择体温是否正常">
            <el-option
                v-for="(item,index) in tiwenshifouzhengchangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="体温是否正常" prop="tiwenshifouzhengchang">
	      <el-input v-model="ruleForm.tiwenshifouzhengchang"
                placeholder="体温是否正常" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="家人中是否有人确诊新冠肺炎" prop="jiarenzhongshifouyourenquezhenxinguanfeiyan">
          <el-select v-model="ruleForm.jiarenzhongshifouyourenquezhenxinguanfeiyan" placeholder="请选择家人中是否有人确诊新冠肺炎">
            <el-option
                v-for="(item,index) in jiarenzhongshifouyourenquezhenxinguanfeiyanOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="家人中是否有人确诊新冠肺炎" prop="jiarenzhongshifouyourenquezhenxinguanfeiyan">
	      <el-input v-model="ruleForm.jiarenzhongshifouyourenquezhenxinguanfeiyan"
                placeholder="家人中是否有人确诊新冠肺炎" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
...
export default {
  data() {
	...
	tiwen : false,
	shentishifoubushi : false,
	tiwenshifouzhengchang : false,
	jiarenzhongshifouyourenquezhenxinguanfeiyan : false,
	beizhu : false,
	dengjishijian : false,
      },
            ruleForm: {
                	        yonghuzhanghao: '',
	                        	        ...
	                        	        tiwen: '',
	                        	        shentishifoubushi: '',
	                        	        tiwenshifouzhengchang: '',
	                        	        jiarenzhongshifouyourenquezhenxinguanfeiyan: '',
	                        	        beizhu: '',
	                        	        dengjishijian: '',
	                      },
                                                                  shentishifoubushiOptions: [],
                                tiwenshifouzhengchangOptions: [],
                                jiarenzhongshifouyourenquezhenxinguanfeiyanOptions: [],
                                                rules: {
                  yonghuzhanghao: [
                                    	                                                              ],
                  yonghuxingming: [
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tiwen = true;
            continue;
	            	            ...
	            	            if(o=='shentishifoubushi'){
            this.ruleForm.shentishifoubushi = obj[o];
	    this.ro.shentishifoubushi = true;
            continue;
          }
	            	            if(o=='tiwenshifouzhengchang'){
            this.ruleForm.tiwenshifouzhengchang = obj[o];
	    this.ro.tiwenshifouzhengchang = true;
            continue;
          }
	            	            if(o=='jiarenzhongshifouyourenquezhenxinguanfeiyan'){
            this.ruleForm.jiarenzhongshifouyourenquezhenxinguanfeiyan = obj[o];
	    this.ro.jiarenzhongshifouyourenquezhenxinguanfeiyan = true;
            continue;
          }
	            	            if(o=='beizhu'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                this.shentishifoubushiOptions = "是,否".split(',')
                                        this.tiwenshifouzhengchangOptions = "是,否".split(',')
                                        this.jiarenzhongshifouyourenquezhenxinguanfeiyanOptions = "是,否".split(',')
                                                                },
                                                                        // 多级联动参数
                                                                                            info(id) {
      this.$http({
