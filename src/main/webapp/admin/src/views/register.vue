  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(25, 169, 123, 1);fontSize:28px;">疫情之下社区管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="籍贯" class="input" v-if="tableName=='yonghu'">
			...
			<el-form-item label="家庭住址" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.jiatingzhuzhi" autocomplete="off" placeholder="家庭住址" type="text" />
			</el-form-item>
																								<!-- <div v-if="tableName=='shequrenyuan'" class="input-group">
			   <div class="label">社区账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shequzhanghao" class="input" type="text" placeholder="社区账号">
			   </div>
			 </div> -->
			<el-form-item label="社区账号" class="input" v-if="tableName=='shequrenyuan'">
			  <el-input v-model="ruleForm.shequzhanghao" autocomplete="off" placeholder="社区账号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='shequrenyuan'" class="input-group">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='shequrenyuan'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='shequrenyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='shequrenyuan'" class="input-group">
			   <div class="label">年龄</div>
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='shequrenyuan'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='shequrenyuan'" class="input-group">
			...
			<el-form-item label="职务" class="input" v-if="tableName=='shequrenyuan'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='shequrenyuan'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='shequrenyuan'" class="input-group">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='shequrenyuan'">
			...
			<el-form-item label="家庭地址" class="input" v-if="tableName=='shequrenyuan'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                  ...
                                                                                                                  if((!this.ruleForm.shequzhanghao) && `shequrenyuan` == this.tableName){
        this.$message.error(`社区账号不能为空`);
        return
      }
                                                                                                                                                                                                                                                                                                                                                                        if(`shequrenyuan` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
        this.$message.error(`联系电话应输入手机格式`);
        return
      }
                                                                              if(`shequrenyuan` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210128/14f2d01f41fe421db42c90ddf6b8a150.jpg");
		height: 100vh;
